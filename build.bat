...
"C:\Users\Admin\AppData\Local\Microsoft\WindowsApps\python3.11.exe" -m PyInstaller --noconsole --onefile --icon=favicon/favicon.ico --add-data "favicon;favicon" --version-file=version.txt main.py
